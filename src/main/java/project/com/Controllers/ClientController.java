...
public class ClientController {
     ...
     */
    @RequestMapping(value = "/connect_crew_to_client/{crewId}/{clientId}", method = RequestMethod.PUT)
    public ResponseEntity<ClientDTO> addCrewToClient(@PathVariable Long crewId, @PathVariable Long clientId) {
